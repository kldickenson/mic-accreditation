...
class FP_Tabs {
	...
	public function fp_tab( $atts, $content = null ){
		...
		if ( $fp_globals['tab_title'] ){
			...
			if ( $atts['open'] == 'true' ) {
				$html = "<li class='tab-title  ".esc_html( $fp_globals['open_tab'] )."'><a href=#".esc_html( $fp_globals['tab_id'] ).">". esc_html( $atts['title'] ) ."</a></li>";
			} else {
				$html = "<li class='tab-title'><a href=#".esc_html( $fp_globals['tab_id'] ).">". esc_html( $atts['title'] ) ."</a></li>";
			}	

		} else {

			if ( $atts['open'] == 'true' ) {				
				$html = "<div id='".esc_html( $fp_globals['tab_id'] )."' class='content ".esc_html( $fp_globals['open_tab'] ).esc_html( $class )."'><div class='fp-tab-content'>". do_shortcode( $atts['content'] )."</div></div>";
			} else {
				$html = "<div id='".esc_html( $fp_globals['tab_id'] )."' class='content".esc_html( $class )."'><div class='fp-tab-content'>". do_shortcode( $atts['content'] )."</div></div>";
			}	
		}		
            return $html;
        }
...
class FP_Accordion {
	...
	public function fp_accordion( $atts, $content = null ){
		...
		$html .= "<a href=#".esc_html( $fp_globals['accordion_id'] ).">".esc_html( $atts['title'] )."</a>";

		if ( $atts['open'] == 'true' ) {				
			$html .= "<div id='".esc_html( $fp_globals['accordion_id'] )."' class='content ".esc_html( $fp_globals['open_tab'] ).esc_html( $class )."'>". do_shortcode( $atts['content'] )."</div>";
		} else {
			$html .= "<div id='".esc_html( $fp_globals['accordion_id'] )."' class='content".esc_html( $class )."'>". do_shortcode( $atts['content'] )."</div>";
		}	
...
class FP_Menu {
	...
	public function fp_menu( $atts, $content ) {
		...
		$html = '<ul class="sub-nav'.esc_html( $class ).'">';		
		$html .=  do_shortcode( $atts['content'] );
		$html .= '</ul>';
...
class FP_Button {
	...
	public function fp_button( $atts, $content ) {
		...
		if ( in_array( $atts['size'], array( 'tiny','small', 'large', 'expand' ), true ) )  { $button_classes[] = $atts['size'].' '; } 
		if ( in_array( $atts['color'], array( 'secondary', 'success', 'alert', 'warning', 'disabled' ), true ) ) { $button_classes[] = $atts['color'].' '; } 
		...
		if ( $atts['type'] =='link' ) { 
			...
			$link = '';
			if ( $atts['type'] == 'submit' ) { $type = ' type=submit'; } elseif ( $atts['type'] == 'reset' ) { $type = ' type=reset'; } else { $type = '';}
...
class FP_Callout {
	...
	public function fp_callout( $atts, $content ) {
		...
		if ( in_array( $atts['color'], array( 'secondary', 'success', 'alert', 'warning', 'primary', 'info' ), true ) ) { $callout_classes[] = $atts['color'].' '; } 
...
class FP_Dropdown {
	...
	public function fp_dropdown( $atts, $content ) {
		...
		if ( in_array( $atts['position'], array( 'top', 'right', 'left', 'down' ), true ) ) { $position = 'ignore_repositioning:true;align: '.$atts['position'].';'; } else { $position = ''; }
		if ( $atts['hover'] == 'true' ) { $hover = 'is_hover:true; hover_timeout:500;'; } else { $hover = ''; }
		if ( !empty( $atts['class'] ) ) { $class = $atts['class'].' '; } else { $class = ''; }	

		$html = '<a data-dropdown="'.esc_html( $fp_globals['dropdown_id'] ).'" aria-controls="'.esc_html( $fp_globals['dropdown_id'] ).'" aria-expanded="false"  data-options="'.esc_html( $hover ).esc_html( $position ).'">'.esc_html( $atts['title'] ).'</a>';
...
class FP_Label {
	...
	public function fp_label( $atts, $content ) {
		...
		if ( in_array( $atts['color'], array( 'secondary', 'success', 'alert', 'warning', 'info'  ), true ) ) { $label_classes[] = $atts['color'].' '; } 
...
class FP_Orbit {
	...
	public function fp_orbits( $atts, $content ) {
		...
		if ( !empty( $atts['class'] ) ) { $html .= '<div class="'.esc_html( $atts['class'] ).'">';}	
...
class FP_Progress {
	...
	public function fp_progress( $atts, $content ) {
		...
		if ( in_array( $atts['color'], array( 'secondary', 'success', 'alert' ), true ) ) { $color = $atts['color'].' '; } else { $color = ''; } 
		...
		$html .= '<div class="'.esc_html( $color ).'meter" style="width:'.intval( esc_html( $atts['width'] ) ).'%">';
		$html .= '</div></div>';
...
class FP_Reveal {
	...
	public function fp_reveal( $atts, $content ) {
		...
		if ( in_array( $atts['size'], array( 'tiny', 'small', 'medium', 'large', 'xlarge', 'full' ), true ) ) { $size = $atts['size'].' '; } else { $size = ''; }
		if ( !empty( $atts['class'] ) ) { $class = $atts['class'].' '; } else { $class = ''; }	
...
class FP_Visible {
	...
	public function fp_visible( $atts, $content ) {
		...
		if ( $atts['show_xlarge'] 	   == 'true' ) 	{ $show_xlarge 		=	array( 'size' => 'show_xlarge', 		'class' => 'show-for-xlarge-up' );  } else { $show_xlarge = '';}
		if ( $atts['show_xlarge_only'] == 'true' ) 	{ $show_xlarge_only =	array( 'size' => 'show_xlarge_only', 	'class' => 'show-for-xlarge-only' );} else { $show_xlarge_only = '';}
		if ( $atts['hide_xlarge'] 	   == 'true' ) 	{ $hide_xlarge 		=	array( 'size' => 'hide_xlarge', 		'class' => 'hide-for-xlarge-up' );  } else { $hide_xlarge = '';}
		if ( $atts['hide_xlarge_only'] == 'true' ) 	{ $hide_xlarge_only =	array( 'size' => 'hide_xlarge_only', 	'class' => 'hide-for-xlarge-only' );} else { $hide_xlarge_only = '';}
		if ( $atts['show_xxlarge'] 	   == 'true' ) 	{ $show_xxlarge 	=	array( 'size' => 'show_xxlarge', 		'class' => 'show-for-xxlarge-up' ); } else { $show_xxlarge = '';}
		if ( $atts['hide_xxlarge'] 	   == 'true' ) 	{ $hide_xxlarge 	=	array( 'size' => 'hide_xxlarge', 		'class' => 'hide-for-xxlarge-up' ); } else { $hide_xxlarge = '';}
...
class FP_Grid {
	...
	public function fp_rows( $atts, $content ) {
		...
		if ( $atts['row_equalizer'] == 'true' ) { $row_equalizer = ' data-equalizer'; $fp_globals['row_equalizer_watch'] = 'data-equalizer-watch ';} else { $row_equalizer = ''; $fp_globals['row_equalizer_watch'] = '';}
		...
		$options = array( 
			...
			array( 'size' => $atts['medium_up'], 'class' => 'medium-block-grid-' ),  
		...
		if ( empty( $atts['small_up'] ) && empty( $atts['medium_up'] ) && empty( $atts['large_up'] ) ) {
			...
			if ($background) {
				$html = '<div class="'.esc_html( $bool_class ).esc_html( $class ).' row" '.esc_html( $equalizer ).esc_html( $row_equalizer ).' style="background-image:url('.esc_url($background).');background-size:cover;">';
			} else {
			...
			if ($background) {
				$html = '<ul class="'.esc_html( $grid_class ).esc_html( $class ).'" '.esc_html( $equalizer ).esc_html( $row_equalizer ).' style="background-image:url('.esc_url($background).');background-size:cover;">';
			} else {
	...
	public function fp_columns( $atts, $content ){
		...
		$options = array( 
			...
			array( 'size' => $atts['small_push'], 'class' => 'small-push-' ), 
			array( 'size' => $atts['small_pull'], 'class' => 'small-pull-' ),
			array( 'size' => $atts['medium'], 'class' => 'medium-' ), 
			array( 'size' => $atts['medium_offset'], 'class' => 'medium-offset-' ), 
			array( 'size' => $atts['medium_push'], 'class' => 'medium-push-' ), 
			array( 'size' => $atts['medium_pull'], 'class' => 'medium-pull-' ),
			array( 'size' => $atts['large'], 'class' => 'large-' ),
			array( 'size' => $atts['large_offset'], 'class' => 'large-offset-' ), 
			array( 'size' => $atts['large_push'], 'class' => 'large-push-' ), 
			array( 'size' => $atts['large_pull'], 'class' => 'large-pull-' ),

			// Not Supported in F5; Included to support compatibility between the versions;
			array( 'size' => $atts['column'], 'class' => 'large-' ),
			array( 'size' => $atts['offset'], 'class' => 'large-offset-' ), 
			array( 'size' => $atts['push'], 'class' => 'large-push-' ), 
			array( 'size' => $atts['pull'], 'class' => 'large-pull-' ),
		 );
		...
		$bool_options = array( 
			...
			array( 'bool' => $atts['medium_centered'], 'class' => 'medium-centered ' ),
			array( 'bool' => $atts['large_centered'], 'class' => 'large-centered ' ),
			array( 'bool' => $atts['small_uncentered'], 'class' => 'small-uncentered ' ),
			array( 'bool' => $atts['medium_uncentered'], 'class' => 'medium-uncentered ' ),
		...
		if ( $fp_globals['block_grids'] == 'true' ) {
			if ( !empty( $atts['class'] ) ) { $class = ' class='.$atts['class']; }
...
class FP_Carousel {
	...
	public function fp_carousel_item( $atts, $content ) {
		...
		if ( !empty( $atts['image'] ) ) { $html .= '<div class="box-image"><img src="'.esc_html( $att['image'] ).'" alt='.esc_html( $alt ).'></div>'; }
