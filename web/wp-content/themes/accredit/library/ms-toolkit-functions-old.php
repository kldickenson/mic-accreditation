...
// Sidebars for contact, about, and resources

function non_step_sidebar() {

	register_sidebar( array(
		'name'          => 'Other Sidebar (not steps)',
		'id'            => 'non_step_sidebar',
		'description'   => __( 'Sidebar widgets for pages other than the Steps.' ),
...
add_action( 'widgets_init', 'non_step_sidebar' );
